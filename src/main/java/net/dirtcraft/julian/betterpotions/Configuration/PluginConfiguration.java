package net.dirtcraft.julian.betterpotions.Configuration;
...
public class PluginConfiguration {
    ...
    public static class GlobalConfigs {
        ...
        @Setting
        public static boolean JumpBoost = true;
        @Setting
        public static boolean Invisbility = true;
        @Setting
        public static boolean Swiftness = true;
        @Setting
        public static boolean FireResistance = true;
        @Setting
        public static boolean HealthBoost = true;
        @Setting
        ...
        @Setting
        public static boolean Levitation = true;
        @Setting
