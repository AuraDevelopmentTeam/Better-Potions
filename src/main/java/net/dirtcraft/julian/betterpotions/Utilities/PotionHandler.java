...
public class PotionHandler {
    ...
    public static void PotionHandler(PotionEffectType potType, Player player, String potionType, String potionCommand) throws CommandException {
    ...
    private static void giveEffect(PotionEffectType potType, Integer i, Player player, String potionType, String potionCommand) {
