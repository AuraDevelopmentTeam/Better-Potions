...
public class PotionArgsHandler {
    ...
    public static void PotionArgsHandler(PotionEffectType potType, Player player, String potionType, String potionCommand, String potionRange, int minPotency, int maxPotency, CommandContext args) throws CommandException {
        ...
        if (player.get(Keys.POTION_EFFECTS)
            ...
            throw new CommandException(TextSerializers.FORMATTING_CODE.deserialize("&cMust be a value between " + potionRange));
        } else {
            int pot = potency.get();
    ...
    private static void checkEffect(PotionEffectType type, Player player, String potionType, String potionCommand) {
        List<PotionEffect> potionEffects = player.get(Keys.POTION_EFFECTS)
    ...
    private static void giveEffect(PotionEffectType potType, int i, Player player, String potionType, String potionCommand) {
