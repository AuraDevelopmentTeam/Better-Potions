                    ...
                    if (source instanceof Player) {
                        ...
                        if (player.get(Keys.POTION_EFFECTS).isPresent()) {
                            ...
                            PaginationList.builder()
                                    .title(TextSerializers.FORMATTING_CODE.deserialize("&dPotion Effects&8: &aCleared"))
                                    .contents(
                                            Text.builder()
                                                    .append(Text.builder()
                                                            .append(TextSerializers.FORMATTING_CODE.deserialize(
                                                                    "\n&dEffects &7have been &acleared &7for &b" + player.getName() + "\n"))
                                                            .build())
                            ...
                            player.sendMessage(TextSerializers.FORMATTING_CODE.deserialize("&cYou don't have any potion effects!"));
                        }
