...
public class Saturation {
    ...
    private static final String potionName = "Saturation";
    private static final String potionCommand = "saturation";
    ...
    private static final PotionEffectType potionType = PotionEffectTypes.SATURATION;
    private static final String permission = Permissions.SATURATION;
    private static final boolean enabled = PluginConfiguration.GlobalConfigs.Saturation;
