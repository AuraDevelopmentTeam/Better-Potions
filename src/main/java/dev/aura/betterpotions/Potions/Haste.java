...
public class Haste {
  ...
  private static final String potionName = "Haste";
  private static final String potionCommand = "haste";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.HASTE;
  private static final String permission = Permissions.HASTE;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Haste;
