...
public class Poison {
  ...
  private static final String potionName = "Poison";
  private static final String potionCommand = "poison";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.POISON;
  private static final String permission = Permissions.POISON;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Poison;
