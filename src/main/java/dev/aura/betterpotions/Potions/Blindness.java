...
public class Blindness {
  ...
  private static final String potionName = "Blindness";
  private static final String potionCommand = "blindness";
  private static final PotionEffectType potionType = PotionEffectTypes.BLINDNESS;
