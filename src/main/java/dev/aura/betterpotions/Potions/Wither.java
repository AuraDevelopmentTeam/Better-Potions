...
public class Wither {
  ...
  private static final String potionName = "Wither";
  private static final String potionCommand = "wither";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.WITHER;
  private static final String permission = Permissions.WITHER;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Wither;
