...
public class Strength {
  ...
  private static final String potionName = "Strength";
  private static final String potionCommand = "strength";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.STRENGTH;
  private static final String permission = Permissions.STRENGTH;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Strength;
