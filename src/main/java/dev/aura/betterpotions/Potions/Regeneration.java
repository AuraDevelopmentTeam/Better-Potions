...
public class Regeneration {
  private static final String potionName = "Regeneration";
  private static final String potionCommand = "regeneration";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.REGENERATION;
  private static final String permission = Permissions.REGENERATION;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Regeneration;
  ...
  public static CommandSpec build() {
    ...
    return CommandSpec.builder()
        ...
        .arguments(GenericArguments.optional(GenericArguments.integer(Text.of(potionRange))))
        .executor(
            (source, args) -> {
