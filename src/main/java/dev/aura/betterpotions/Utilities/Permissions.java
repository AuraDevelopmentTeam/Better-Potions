...
public class Permissions {
  ...
  public static final String GODMODE = "betterpotions.godmode";
  ...
  public static final String LUCK = "betterpotions.luck";
  public static final String MINING_FATIGUE = "betterpotions.miningfatigue";
  public static final String NAUSEA = "betterpotions.nausea";
  public static final String NIGHT_VISION = "betterpotions.nightvision";
  public static final String POISON = "betterpotions.poison";
  public static final String REGENERATION = "betterpotions.regeneration";
  public static final String RESISTANCE = "betterpotions.resistance";
  public static final String SATURATION = "betterpotions.saturation";
  public static final String SLOWNESS = "betterpotions.slowness";
  public static final String STRENGTH = "betterpotions.strength";
  public static final String SWIFTNESS = "betterpotions.swiftness";
  public static final String WATER_BREATHING = "betterpotions.waterbreathing";
