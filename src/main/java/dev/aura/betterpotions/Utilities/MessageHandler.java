      ...
      potions.add(
          Text.builder()
              .append(
                  Text.builder()
                      .append(
                          TextSerializers.FORMATTING_CODE.deserialize("&d" + potionName + " &a✓"))
                      .build())
              .onHover(
      ...
      potions.add(
          Text.builder()
              .append(
                  Text.builder()
                      .append(
                          TextSerializers.FORMATTING_CODE.deserialize("&d" + potionName + " &c✗"))
                      .build())
              .onHover(
                  TextActions.showText(
                      TextSerializers.FORMATTING_CODE.deserialize("&6&o/potions " + potionCommand)))
