...
public class Nausea {
  ...
  private static final String potionName = "Nausea";
  private static final String potionCommand = "nausea";
  private static final PotionEffectType potionType = PotionEffectTypes.NAUSEA;
  private static final String permission = Permissions.NAUSEA;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Nausea;
