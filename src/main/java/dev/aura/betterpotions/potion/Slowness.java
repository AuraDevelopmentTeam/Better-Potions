...
public class Slowness {
  ...
  private static final String potionName = "Slowness";
  private static final String potionCommand = "slowness";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.SLOWNESS;
  private static final String permission = Permissions.SLOWNESS;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Slowness;
