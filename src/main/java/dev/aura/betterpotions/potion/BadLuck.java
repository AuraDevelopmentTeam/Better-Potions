...
public class BadLuck {

  private static final String potionName = "Bad Luck";
  private static final String potionCommand = "badluck";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.UNLUCK;
  private static final String permission = Permissions.BAD_LUCK;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.BadLuck;
