...
public class Luck {
  ...
  private static final String potionName = "Luck";
  private static final String potionCommand = "luck";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.LUCK;
  private static final String permission = Permissions.LUCK;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Luck;
