...
public class Hunger {
  ...
  private static final String potionName = "Hunger";
  private static final String potionCommand = "hunger";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.HUNGER;
  private static final String permission = Permissions.HUNGER;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Hunger;
