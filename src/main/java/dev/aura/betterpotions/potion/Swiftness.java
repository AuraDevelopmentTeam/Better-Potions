...
public class Swiftness {
  ...
  private static final String potionName = "Swiftness";
  private static final String potionCommand = "swiftness";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.SPEED;
  private static final String permission = Permissions.SWIFTNESS;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Swiftness;
