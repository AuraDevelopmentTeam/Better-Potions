...
public class Absorption {
  ...
  private static final String potionName = "Absorption";
  private static final String potionCommand = "absorption";
  ...
  private static final PotionEffectType potionType = PotionEffectTypes.ABSORPTION;
  private static final String permission = Permissions.ABSORPTION;
  private static final boolean enabled = PluginConfiguration.GlobalConfigs.Aborption;
