...
public class Commands implements CommandExecutor {
  ...
  public CommandResult execute(CommandSource source, CommandContext args) throws CommandException {
    if (source instanceof Player) {
      ...
      if (PluginConfiguration.GlobalConfigs.Aborption
          && player.hasPermission(Permissions.ABSORPTION)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Blindness
          && player.hasPermission(Permissions.BLINDNESS)) {
      ...
      if (PluginConfiguration.GlobalConfigs.FireResistance
          && player.hasPermission(Permissions.FIRE_RESISTANCE)) {
      ...
      if (PluginConfiguration.GlobalConfigs.HealthBoost
          && player.hasPermission(Permissions.HEALTH_BOOST)) {
      ...
      if (PluginConfiguration.GlobalConfigs.InstantDamage
          && player.hasPermission(Permissions.INSTANT_DAMAGE)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Invisbility
          && player.hasPermission(Permissions.INVISIBILITY)) {
      ...
      if (PluginConfiguration.GlobalConfigs.JumpBoost
          && player.hasPermission(Permissions.JUMP_BOOST)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Levitation
          && player.hasPermission(Permissions.LEVITATION)) {
      ...
      if (PluginConfiguration.GlobalConfigs.MiningFatigue
          && player.hasPermission(Permissions.MINING_FATIGUE)) {
      ...
      if (PluginConfiguration.GlobalConfigs.NightVision
          && player.hasPermission(Permissions.NIGHT_VISION)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Regeneration
          && player.hasPermission(Permissions.REGENERATION)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Resistance
          && player.hasPermission(Permissions.RESISTANCE)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Saturation
          && player.hasPermission(Permissions.SATURATION)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Slowness
          && player.hasPermission(Permissions.SLOWNESS)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Strength
          && player.hasPermission(Permissions.STRENGTH)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Swiftness
          && player.hasPermission(Permissions.SWIFTNESS)) {
      ...
      if (PluginConfiguration.GlobalConfigs.WaterBreathing
          && player.hasPermission(Permissions.WATER_BREATHING)) {
      ...
      if (PluginConfiguration.GlobalConfigs.Weakness
          && player.hasPermission(Permissions.WEAKNESS)) {
        ...
        PaginationList.builder()
            .title(
                TextSerializers.FORMATTING_CODE.deserialize(
                    PluginConfiguration.Pagination.Title.replace(
                        "{pluginName}", PLUGIN.getContainer().getName())))
            .contents(potions)
            .padding(
                TextSerializers.FORMATTING_CODE.deserialize(PluginConfiguration.Pagination.Padding))
                ...
                Text.builder()
                    ...
                    .onHover(
                        TextActions.showText(
                            TextSerializers.FORMATTING_CODE.deserialize("&6&o/potions clear")))
      ...
      throw new CommandException(
          TextSerializers.FORMATTING_CODE.deserialize(
              "&cOnly a player can receive potion effects"));
    }
